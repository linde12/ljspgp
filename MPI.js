...
// Modified by Oscar Linde. Temporary solution. Will be switched out.
module.exports = MPI;

var bignum = require('bignum');

var hexstrdump = function (str) {
  if (str === null)
    return "";
  var r = [];
  var e = str.length;
...
MPI.prototype.fromBytes = function (bytes) {
  this.data = bignum(hexstrdump(bytes), 16);
};
...
MPI.prototype.tobignum = function () {
  return this.data;
};

MPI.prototype.frombignum = function (bn) {
  this.data = bn.clone();
};
